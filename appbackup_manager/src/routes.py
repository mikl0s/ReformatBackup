"""
AppBackup Manager - Routes

This module defines the Flask routes for the AppBackup Manager application.
"""
...
def setup_routes(app: Flask, rescan: bool = False) -> None:
    ...
    """
    from appbackup_manager.src.scan import scan_installed_apps
    from appbackup_manager.src.backup import backup_app, get_backup_location
    from appbackup_manager.src.restore import restore_backup, get_backup_versions
    ...
    def update_settings() -> Any:
        ...
        if request.method == 'POST':
            ...
            from appbackup_manager.src.backup import set_backup_location

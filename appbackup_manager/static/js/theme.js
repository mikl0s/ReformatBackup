/**
 * AppBackup Manager - Theme Switching
 * 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const savedTheme = localStorage.getItem('appbackup-theme');
    ...
    if (savedTheme) {
        ...
        localStorage.setItem('appbackup-theme', 'dark');
    }
    ...
    themeToggle.addEventListener('click', function() {
        ...
        localStorage.setItem('appbackup-theme', newTheme);
    ...
    if (window.matchMedia) {
        ...
        const handleSystemThemeChange = (event) => {
            ...
            if (!localStorage.getItem('appbackup-theme-manual')) {
        ...
        themeToggle.addEventListener('click', function() {
            localStorage.setItem('appbackup-theme-manual', 'true');
        });
    }
});